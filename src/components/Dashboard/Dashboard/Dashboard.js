    ...
    const drawer = (
        <div>
...

          {
           !admin && <Box>
                <List>
                    <Link to={`/dashboard/myCompare`}><Button color="inherit">My Compare</Button></Link>
                </List>
                </Box>  
          } 
            ...
            {admin && <Box sx={{textDecoration:'none'}}>
               ...
               <List>
                <Link to={`/dashboard/addBlog`}><Button color="inherit">Add Blog</Button></Link>
               </List>              
               <List>
                <Link to={`/dashboard/manageCompare`}><Button color="inherit">Manage Compares</Button></Link>
               </List>              
               <List>
                <Link to={`/dashboard/manageBlogs`}><Button color="inherit">Manage Blogs</Button></Link>
               </List>              
            </Box>
            }
